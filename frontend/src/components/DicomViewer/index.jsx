...
//     setDicomImageRef(el => {
//       console.log("path_image:",el);
//       setDicomImage(el);
//     };)
//   }

//   useComponentWillMount(() => initial_load());
//   useComponentDidMount(() => loadImage());

//   const loadImage = () => {
//       console.log("DidMount");
//       const element = dicomImage;
//       console.log("Image",dicomImage )
...
//     disableAllTools();
//     cornerstoneTools[toolName].activate(dicomImage, mouseButtonNumber);
//   };
